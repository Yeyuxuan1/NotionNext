...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '冬瓜', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '大家好，我是冬瓜，我会持续为大家带来优质内容', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'fulishe1.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '网络资源, 福利姬', // 网站关键词 英文逗号隔开
